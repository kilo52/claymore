...
/**
 * An object that binds strongly typed columns into one data structure. All columns have equal
 * length but each column can be of a different type. Columns can have a name associated with 
 * them so they can be accessed through that name without knowledge of the index the column is 
 * located at.
 * 
 * <p>All implementations of this interface work with the {@link Column} type, which represents
 * any column of a particular DataFrame. In order to ensure type safety the concrete type of
 * each column must be specified at compile time.
 * 
 * <p>All implementing classes provide at least three constructors: a void (no arguments) 
 * constructor which creates an empty DataFrame, a constructor which takes multiple arguments of
 * type <code>Column</code>, creating a DataFrame composed of the given unnamed columns, and a 
 ...
 * incoherent/invalid state of that DataFrame. Javadocs of specific methods will not mention
 * this again since <code>DataFrameException</code> is a <Code>RuntimeException</code>.
 * 
 * <p>This interface also provides various static utility methods to work with DataFrames.
 * 
 * @author Phil Gaiser
 ...
 *
 */
public interface DataFrame extends Cloneable, Serializable, Iterable<Column> {

	/**
	 * Gets the byte at the specified column and row index. If the underlying DataFrame
	 * implementation doesn't support null values, then the returned Byte object is guaranteed
	 * to be non-null
	 * 
	...
	/**
	 * Gets the byte from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Short object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the short from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Integer object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the int from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Long object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the long from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned String object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the string from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Float object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the float from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Double object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the double from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Character object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the char from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the returned Boolean object is guaranteed
	 * to be non-null
	 * 
	 * @param col The column index of the value to get
	 * @param row The row index of the value to get
	...
	/**
	 * Gets the boolean from the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Byte object must not be null
	 * 
	...
	/**
	 * Sets the byte at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Short object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the short at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Integer object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the int at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Long object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the long at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values or empty strings, then the provided String
	 * object will be converted to 'n/a' if it is null or empty
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the string at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values
	 * or empty strings, then the provided String object will be converted to 'n/a' if it is 
	 * null or empty
	 * 
	 * @param colName The name of the column to set the value at
	 * @param row The row index of the value to set
	 ...
	 * implementation doesn't support null values, then the provided Float object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the float at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Double object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the double at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Character object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the char at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	 ...
	 * implementation doesn't support null values, then the provided Boolean object must not be null
	 * 
	 * @param col The column index of the value to set
	 * @param row The row index of the value to set
	...
	/**
	 * Sets the boolean at the specified column at the specified row index. The column must be
	 * specified by name. If the underlying DataFrame implementation doesn't support null values,
	...
	/**
	 * Gets the name of all columns of this DataFrame in proper order. Columns which have not been
	 * named will be represented as their index within the DataFrame
	 * 
	...
	/**
	 * Gets the index of the column with the specified name. <p>This method may throw a 
	 * {@link DataFrameException} if no column of this DataFrame has the specified name or if 
	...
	/**
	 * Assigns all columns the specified name. Any previous names will get overridden. Make sure
	 * that the length of the provided array matches the number of columns in this DataFrame.
	 * <p>Please note that no checks will be performed regarding duplicates. Assigning more than 
	 * one column the same name will result in undefined behaviour
	 * 
	...
	/**
	 * Assigns the specified column the specified name. No checks will be performed regarding
	 * duplicates. Assigning more than one column the same name will result in undefined behaviour.
	 * A return value is being provided to indicate whether any previous name of the specified
	...
	/**
	 * Indicates whether this DataFrame has set any column names. Please note that this method returns
	 * true even when column names are only partially set, i.e. not all columns must have a name assigned
	 * to them. In other words, this method returns true if at least one column has a name assigned to it
	 * 
	 * @return True if this DataFrame has any column names set, false if no column names have been set
	 */
	public boolean hasColumnNames();
	
	/**
	 * Gets the row at the specified index. If the underlying DataFrame implementation doesn't 
	 * support null values, then the returned array is guaranteed to consist of non-null values
	 * 
	 ...
	 * length of the provided array is equal to the number of columns in this DataFrame
	 * 
	 ...
	 * equal to the type of the column it is placed in. If the underlying DataFrame implementation 
	 * doesn't support null values, then passing an array with null values will result in a 
	 * {@link DataFrameException}. Make sure the length of the provided array is equal to the
	 * number of columns in this DataFrame
	 * 
	 * @param row The row to add represented as an array of Objects
	 */
	 ...
	 * underlying DataFrame implementation doesn't support null values, then passing an array with 
	 * null values will result in a {@link DataFrameException}. Make sure the length of the provided
	 * array is equal to the number of columns in this DataFrame
	 * 
	...
	/**
	 * Removes all rows from (inclusive) the specified index to (exclusive) the specified index
	 * 
	...
	/**
	 * Adds the provided column to this DataFrame. If the underlying DataFrame implementation 
	 * doesn't support null values, then the size of the provided column must match the size of
	 * the already existing columns. If the underlying DataFrame implementation supports null 
	 * values and has a deviating size or the provided column has a deviating size, then the
	 * DataFrame will refill all missing entries with null values to match the largest column
	 * 
	...
	/**
	 * Adds the provided column to this DataFrame and assigns it the specified name. If the 
	 * underlying DataFrame implementation doesn't support null values, then the size of the
	 * provided column must match the size of the already existing columns. If the underlying
	 * DataFrame implementation supports null values and has a deviating size or the provided
	 * column has a deviating size, then the DataFrame will refill all missing entries with 
	 * null values to match the largest column. <p>Please note that no checks will be performed
	 * regarding duplicate column names. Assigning more than one column the same name will 
	...
	/**
	 * Inserts the provided column at the specified index to this DataFrame and assigns it the specified 
	 * name. Shifts all columns currently at that position and any subsequent columns to the right 
	 * (adds one to their indices).  
	 * <p>If the underlying DataFrame implementation doesn't support null values, then the 
	 * size of the provided column must match the size of the already existing columns. 
	 * If the underlying DataFrame implementation supports null values and has a deviating
	 * size or the provided column has a deviating size, then the DataFrame will refill all
	 * missing entries with null values to match the largest column.
	 * <p>Please note that no checks will be performed regarding duplicate column names. Assigning more 
	...
	/**
	 * Indicates the capacity of each column within this DataFrame. The Capacity is the number of entries
	 * any given column can hold without the need of resizing. Therefore this method is different 
	 * from <code>rows()</code> because <code>capacity()</code> also indicates the allocated space of the 
	 ...
	 * 
	 * @return True if this DataFrame supports null values, false if it does not support null values
	 * @see DefaultDataFrame
	 * @see NullableDataFrame
	 */
	...
	/**
	 * Removes all rows from this DataFrame and frees up allocated space. However, the column structure
	 * will not be changed by this operation
	 */
	public void clear();
	
	/**
	 * Changes the capacity of each column to match the actually needed space by the entries currently
	 * in this DataFrame. Therefore, subsequently adding rows will require further resizing.
	 * <p>This method can be called when unnecessary space allocation should get freed up
	 */
	public void flush();
	
	/**
	 * Gets a reference of the {@link Column} instance at the specified index. Any changes to that column
	 * are reflected in the DataFrame, and vice-versa
	 * 
	...
	/**
	 * Gets a reference of the {@link Column} instance with the specified name. Any changes to that column
	 * are reflected in the DataFrame, and vice-versa
	 * 
	...
	/**
	 * Sets and replaces the {@link Column} at the specified index with the provided Column
	 * 
	...
	/**
	 * Computes and returns the index of the first occurrence that matches the specified regular 
	 * expression in the column at the specified index
	 * 
	 * @param col The index of the column to search 
	 * @param regex The regular expression to search for
	 * @return The index of the row which matches the given regular expression in the specified column.<br>
	 * 		   <b>-1</b> if nothing in the column matches the given regular expression
	 */
	...
	/**
	 * Computes and returns the index of the first occurrence that matches the specified regular 
	 * expression in the column at the specified index, while starting to search from the given row
	 * index to the end of the DataFrame
	 * 
	 * @param col The index of the column to search 
	...
	/**
	 * Computes and returns the index of the first occurrence that matches the specified regular 
	 * expression in the column with the specified name, while starting to search from the given row
	 * index to the end of the DataFrame
	 * 
	 * @param colName The name of the Column to search
	 * @param startFrom The row index from which to start searching
	...
	/**
	 * Computes and returns the indices of all occurrences that match the specified regular expression in
	 * the column at the specified index
	 * 
	 * @param col The index of the column to search 
	 * @param regex The regular expression  to search for
	 * @return An array containing all indices in proper order of all occurrences that match the given 
	 * 		   regular expression. Returns Null if nothing in the column matches the given 
	 * 		   regular expression
	 */
	 ...
	 * expression in the column at the specified index. All rows in the returned DataFrame are copies
	 * of the original rows, so changing values within the returned DataFrame has no effect on the
	...
	/**
	 * Computes and returns a {@link DataFrame} containing all rows that match the specified regular
	 * expression in the column with the specified name. All rows in the returned DataFrame are copies
	 * of the original rows, so changing values within the returned DataFrame has no effect on the
	 * original DataFrame, and vice-versa
	 * 
	 * @param colName The name of the Column to search
	 ...
	 * implementation supports null values, then null values are excluded from the computation
	 * and do not contribute to the total number of entries. The average can only be computed for
	...
	/**
	 * Computes the minimum of all entries in the specified column. If the underlying DataFrame
	 * implementation supports null values, then null values are excluded from the computation. 
	...
	/**
	 * Computes the maximum of all entries in the specified column. If the underlying DataFrame
	 * implementation supports null values, then null values are excluded from the computation. 
	...
	/**
	 * Returns this DataFrame as an array of Objects. The first dimension contains the
	 * columns of the DataFrame and the second dimension contains the entries of each
	 * column (i.e. rows). The returned array is not backed by the DataFrame, so changing
	 * entries in the array has no effect on the DataFrame, and vice-versa
	 * 
    ...
    public static DataFrame copyOf(final DataFrame df){
    	...
    	for(final Column col : df){
    		copy.addColumn((Column)col.clone());
    	}
	 ...
	 * occurrences to the primitive defaults according to the column they are located.<br>
