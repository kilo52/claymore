...
/**
 * Column holding nullable float values.<br>
 ...
 *
 */
public class NullableFloatColumn extends NullableColumn implements Cloneable, Serializable {
	...
	public Object clone(){
		...
		return new NullableFloatColumn(clone);
	}
