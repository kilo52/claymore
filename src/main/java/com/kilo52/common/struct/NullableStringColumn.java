...
/**
 * Column holding nullable string values.<br>
 * Any values not explicitly set are considered null.
 * 
 * @see StringColumn
 *
 */
public class NullableStringColumn extends NullableColumn implements Cloneable, Serializable {
	...
	public Object clone(){
		...
		return new NullableStringColumn(clone);
	}
