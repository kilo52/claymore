 ...
 * Furthermore, that class must declare a default no-arguments constructor.
 * 
 ...
 * some of which may not be annotated as a row item. Those fields are exluded and
 * ignored when passing an instance of a class to a DataFrame for an operation 
 * regarding rows. 
 * 
 * @author Phil Gaiser
 * @see RowItem
